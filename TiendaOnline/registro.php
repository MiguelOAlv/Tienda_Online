    ...
    <div class="col-md-6 offset-md-3">
      ...
      <form action="recogidaRegistro.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="file" class="form-control-file" id="avatar" name="avatar" accept="image/jpeg, image/png" required>
          <small class="form-text text-muted">Formatos permitidos: JPG, JPEG, PNG. Tamaño máximo: 100 KB.</small>
        </div>
        <?php
        if (isset($_GET["error"])) {
          $error = $_GET["error"];
